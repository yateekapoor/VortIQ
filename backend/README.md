...
The published site is deliberately static. `assets/js/app.js` uses safe browser simulations so it can run on GitHub Pages. A real system should place analysis and sensitive operational data behind a private backend, never in the frontend or Git repository.
